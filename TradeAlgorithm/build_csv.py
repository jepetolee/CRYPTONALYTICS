...
def build_1day_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/1day/daily_data_' + symbol[i] + '.csv')
...
def build_1hour_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/1hour/1hour_data_' + symbol[i] + '.csv')
...
def build_4hour_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/4hour/4hour_data_' + symbol[i] + '.csv')
...
def build_30min_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/30min/30min_data_' + symbol[i] + '.csv')
...
def build_15min_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/15min/15min_data_' + symbol[i] + '.csv')
...
def build_5min_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/5min/5min_data_' + symbol[i] + '.csv')
...
def build_1min_csv():
    ...
    for i in trange(len(symbol)):
        ...
        day.to_csv('./csv/market/1min/1min_data_' + symbol[i] + '.csv')
...
def build_future_1hour_csv():
    ...
    for i in trange(len(symbol)):
        day = pd.DataFrame(
            client.futures_historical_klines(symbol=symbol[i], interval='1h', start_str="2017-01-01", limit=1000))
